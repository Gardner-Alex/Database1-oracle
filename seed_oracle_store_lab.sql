...
@/home/student/Data/cit225/oracle/lab2/create_oracle_store_lab.sql
@/home/student/Data/cit225/oracle/lab4/seed_oracle_store.sql

-- Open log file.
SPOOL seed_oracle_store_lab.log
...
,(SELECT   r.rental_id
  ...
  AND      c.first_name = 'Oscar')
,(SELECT   d.item_id
  FROM     item_lab d join common_lookup cl
